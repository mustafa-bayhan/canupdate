var Particles = (function (t, e) {
    ...
    return (
        ((n = (function () {
            return function () {
                var t = this;
                (t.defaults = { responsive: null, selector: null, maxParticles: 50, sizeVariations: 2, showParticles: !0, speed: 0.4, color: "#000000", minDistance: 100, connectParticles: !1 }),
                    (t.element = null),
                    (t.context = null),
                    (t.ratio = null),
                    (t.breakpoints = []),
        ...
        (n.prototype._initializeCanvas = function () {
            ...
            (o.element = e.querySelector(o.options.selector)),
                ...
                "BODY" === o.element.offsetParent.nodeName ? (o.element.height = t.innerHeight * o.ratio) : (o.element.height = o.element.offsetParent.clientHeight * o.ratio),
        ...
        (n.prototype._resize = function () {
            ...
            (e.element.width = e.element.offsetParent.clientWidth * e.ratio),
                "BODY" === e.element.offsetParent.nodeName ? (e.element.height = t.innerHeight * e.ratio) : (e.element.height = e.element.offsetParent.clientHeight * e.ratio),
        ...
        ((i = function (n, i) {
            ...
            (o.x = r() * l.offsetParent.clientWidth),
                "BODY" === l.offsetParent.nodeName ? (o.y = r() * t.innerHeight) : (o.y = r() * l.offsetParent.clientHeight),
                (o.vx = r() * a * 2 - a),
                (o.vy = r() * a * 2 - a),
